...
export class DeveloperAnalyticsService {
  ...
  public static async getAssessmentMetrics(assessmentId: number, userRole: UserRole) {
    if (userRole !== UserRole.DEVELOPER) {
      throw new CustomError("Only developers can access assessment metrics", 403);
    }
  ...
  public static async getUserEngagementAnalytics(userRole: UserRole) {
    if (userRole !== UserRole.DEVELOPER) {
      throw new CustomError("Only developers can access user engagement analytics", 403);
    }
  ...
  public static async getCertificateTrends(userRole: UserRole) {
    if (userRole !== UserRole.DEVELOPER) {
      throw new CustomError("Only developers can access certificate trends", 403);
    }
  ...
  public static async exportAnalyticsData(userRole: UserRole, format: 'json' | 'csv' = 'json') {
    if (userRole !== UserRole.DEVELOPER) {
      throw new CustomError("Only developers can export analytics data", 403);
    }
