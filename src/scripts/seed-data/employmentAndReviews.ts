  ...
  await prisma.companyReview.createMany({
    data: [
      ...
      // Company review for Gina (UX Designer) - using updated employment record
      {
        ...
        isVerifiedEmployee: true,
        isAnonymous: true,
        ratingCulture: new Prisma.Decimal("4.80"),
        ratingFacilities: new Prisma.Decimal("4.50"),
        ratingWorkLife: new Prisma.Decimal("4.70"),
        ratingCareer: new Prisma.Decimal("4.60"),
        salaryEstimateMin: 16_000_000,
        salaryEstimateMax: 18_000_000,
      ...
      // NEW: Company review for Eko - using employment record
      {
        ...
        ratingCulture: new Prisma.Decimal("4.70"),
        ratingFacilities: new Prisma.Decimal("4.40"),
        ratingWorkLife: new Prisma.Decimal("4.50"),
        ratingCareer: new Prisma.Decimal("4.80"),
        salaryEstimateMin: 20_000_000,
        salaryEstimateMax: 24_000_000,
      ...
      // ADDITIONAL REVIEWS FOR TECHCORP (for better rating testing)
      {
        ...
        isVerifiedEmployee: true,
        isAnonymous: true,
        ratingCulture: new Prisma.Decimal("4.20"),
        ratingFacilities: new Prisma.Decimal("4.00"),
        ratingWorkLife: new Prisma.Decimal("3.80"),
        ratingCareer: new Prisma.Decimal("4.40"),
        salaryEstimateMin: 28_000_000,
        salaryEstimateMax: 35_000_000,
      ...
      },
      {
        ...
        isVerifiedEmployee: true,
        isAnonymous: true, // Make anonymous for consistency
        ratingCulture: new Prisma.Decimal("4.90"),
        ratingFacilities: new Prisma.Decimal("4.70"),
        ratingWorkLife: new Prisma.Decimal("4.60"),
        ratingCareer: new Prisma.Decimal("4.50"),
        salaryEstimateMin: 32_000_000,
        salaryEstimateMax: 40_000_000,
      ...
      // ADDITIONAL REVIEWS FOR CREATIVE STUDIO (for better rating testing)
      {
        ...
        ratingFacilities: new Prisma.Decimal("4.30"),
        ratingWorkLife: new Prisma.Decimal("4.40"),
        ratingCareer: new Prisma.Decimal("4.20"),
        salaryEstimateMin: 12_000_000,
        salaryEstimateMax: 16_000_000,
      ...
      },
      {
        ...
        ratingFacilities: new Prisma.Decimal("3.90"),
        ratingWorkLife: new Prisma.Decimal("4.00"),
        ratingCareer: new Prisma.Decimal("3.80"),
        salaryEstimateMin: 15_000_000,
        salaryEstimateMax: 20_000_000,
      ...
      // ADDITIONAL REVIEWS FOR FINTECH LABS (for comprehensive testing)
      {
        ...
        isVerifiedEmployee: true,
        isAnonymous: true, // Make anonymous for consistency
        ratingCulture: new Prisma.Decimal("4.30"),
        ratingFacilities: new Prisma.Decimal("4.10"),
        ratingWorkLife: new Prisma.Decimal("3.90"),
        ratingCareer: new Prisma.Decimal("4.60"),
        salaryEstimateMin: 35_000_000,
        salaryEstimateMax: 45_000_000,
      ...
      },
      {
        ...
        ratingWorkLife: new Prisma.Decimal("3.70"),
        ratingCareer: new Prisma.Decimal("4.20"),
        salaryEstimateMin: 22_000_000,
