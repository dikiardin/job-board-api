...
dotenv.config();
import { PrismaClient, ApplicationStatus, InterviewStatus } from "../generated/prisma";
...
<li>Database optimization skills</li>
  ...
  const appAlice = await prisma.application.create({
    data: {
      ...
      timeline: {
        create: [
          { status: ApplicationStatus.SUBMITTED, note: "Application submitted", createdAt: addDays(-5), createdById: alice.id },
          { status: ApplicationStatus.IN_REVIEW, note: "CV under review", createdAt: addDays(-3), createdById: adminTechCorp.id },
          { status: ApplicationStatus.INTERVIEW, note: "Interview scheduled", createdAt: addDays(-1), createdById: adminTechCorp.id },
        ],
      },
    },
  });
  ...
  const appBob = await prisma.application.create({
    data: {
      ...
      timeline: {
        create: [
          { status: ApplicationStatus.SUBMITTED, note: "Application submitted", createdAt: addDays(-2), createdById: bob.id },
        ],
      },
    },
  });
  ...
  const appCitra = await prisma.application.create({
    data: {
      ...
      timeline: {
        create: [
          { status: ApplicationStatus.SUBMITTED, note: "Application with portfolio", createdAt: addDays(-10), createdById: citra.id },
          { status: ApplicationStatus.IN_REVIEW, note: "Design challenge assigned", createdAt: addDays(-7), createdById: adminCreative.id },
          { status: ApplicationStatus.INTERVIEW, note: "Panel interview completed", createdAt: addDays(-3), createdById: adminCreative.id },
          { status: ApplicationStatus.ACCEPTED, note: "Offer letter signed", createdAt: addDays(-1), createdById: adminCreative.id },
        ],
      },
    },
  });
  ...
  const appDimas = await prisma.application.create({
    data: {
      ...
      timeline: {
        create: [
          { status: ApplicationStatus.SUBMITTED, note: "Application received", createdAt: addDays(-8), createdById: dimas.id },
          { status: ApplicationStatus.IN_REVIEW, note: "Screening call completed", createdAt: addDays(-6), createdById: adminFintech.id },
          { status: ApplicationStatus.REJECTED, note: "Not aligned with current needs", createdAt: addDays(-4), createdById: adminFintech.id },
        ],
      },
    },
  });
  ...
  const appEndah = await prisma.application.create({
    data: {
      ...
      cvFileSize: 223_000,
      expectedSalary: 13_000_000,
      expectedSalaryCurrency: "IDR",
      status: ApplicationStatus.IN_REVIEW,
      referralSource: "Instagram",
      timeline: {
        create: [
          { status: ApplicationStatus.SUBMITTED, note: "Application with campaign samples", createdAt: addDays(-1), createdById: endah.id },
          { status: ApplicationStatus.IN_REVIEW, note: "Reviewing campaign portfolio", createdAt: now, createdById: adminCreative.id },
        ],
      },
    },
  });
  ...
  const appFajar = await prisma.application.create({
    data: {
      ...
      timeline: {
        create: [
          { status: ApplicationStatus.SUBMITTED, note: "Application submitted", createdAt: addDays(-4), createdById: fajar.id },
          { status: ApplicationStatus.IN_REVIEW, note: "Technical screening", createdAt: addDays(-2), createdById: adminFintech.id },
          { status: ApplicationStatus.INTERVIEW, note: "Moving to onsite interview", createdAt: now, createdById: adminFintech.id },
        ],
      },
    },
  });
