        ...
        try {
            ...
            if (user.emailVerifiedAt) {
                ...
                return {
                    ...
                    token: jwt,
                    user: { ...user, isProfileComplete: (0, profileCompletion_1.resolveIsProfileComplete)(extendedUser) },
                };
            }
            const updatedUser = await user_repository_1.UserRepo.verifyUser(decoded.userId);
            const extendedUser = (await user_repository_1.UserRepo.findWithCompany(updatedUser.id)) ?? {
                ...updatedUser,
                ownedCompany: null,
            };
