export declare class RenewalPaymentService {
    static createPayment(subscriptionId: number, amount: number): Promise<{
        subscription: {
            plan: {
                name: string;
                createdAt: Date;
    ...
    static getPendingPayment(userId: number, subscriptionIds: number[]): Promise<({
        subscription: {
            user: {
                email: string;
                name: string | null;
...
//# sourceMappingURL=renewalPayment.service.d.ts.map