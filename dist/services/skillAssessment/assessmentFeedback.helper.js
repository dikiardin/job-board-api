...
exports.isPassingScore = exports.getPassingScore = exports.calculateScoreBreakdown = exports.getAssessmentFeedback = void 0;
const getAssessmentFeedback = (score, correctAnswers, totalQuestions, assessmentPassScore) => {
...
exports.getAssessmentFeedback = getAssessmentFeedback;
const calculateScoreBreakdown = (answers) => {
...
exports.calculateScoreBreakdown = calculateScoreBreakdown;
const getPassingScore = (assessmentPassScore) => {
    return assessmentPassScore || 75;
};
exports.getPassingScore = getPassingScore;
const isPassingScore = (score, assessmentPassScore) => {
    const passScore = assessmentPassScore || 75;
    return score >= passScore;
};
exports.isPassingScore = isPassingScore;
