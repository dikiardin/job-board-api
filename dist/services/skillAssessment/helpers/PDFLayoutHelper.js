...
exports.PDFLayoutHelper = void 0;
class PDFLayoutHelper {
    static addBorders(doc, pageWidth, pageHeight) {
    ...
    static addBackgroundPattern(doc) {
        const primaryColor = "#467EC7";
        for (let i = 0; i < 15; i++) {
            for (let j = 0; j < 10; j++) {
    ...
    static addCertificationText(doc, centerX) {
    ...
    static addUserName(doc, centerX, userName) {
        const primaryColor = "#467EC7";
        const goldColor = "#FFD700";
        const darkGray = "#2D3748";
        doc.fontSize(32)
    ...
    static addAssessmentTitle(doc, centerX, assessmentTitle) {
    ...
    static addBadgeInfo(doc, centerX, badgeName) {
        const goldColor = "#FFD700";
        doc.fontSize(16)
            .fillColor(goldColor)
            .font('Helvetica-Bold')
