...
export declare class SubscriptionController {
    ...
    static renewSubscription(req: Request, res: Response, next: NextFunction): Promise<void>;
    static getRenewalInfo(req: Request, res: Response, next: NextFunction): Promise<void>;
}
