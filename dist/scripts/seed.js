...
async function seed() {
    ...
    const devPassword = await (0, hashPassword_1.hashPassword)("work00dev");
    const goldPassword = await (0, hashPassword_1.hashPassword)("gold12345");
    ...
    async function addPreselection(jobId, questionCount = 5, passingScore = 4, jobTitle) {
    ...
    await prisma.jobShare.create({
        data: {
            userId: charlie.id,
            jobId: jobFrontend.id,
            platform: prisma_1.SharePlatform.TWITTER,
