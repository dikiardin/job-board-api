...
exports.buildVerificationEmail = void 0;
const buildVerificationEmail = (name, token) => {
    return `
            ...
            <div style="text-align: center; margin: 30px 0;">
              <div style="border: 1px solid #ddd; border-radius: 8px; padding: 20px; display: inline-block; background-color: #f9f9f9;">
                <p style="text-align: center; margin: 0 0 15px 0;">
                  <a href="${process.env.FE_URL}/auth/verify/${token}" target="_blank" 
                ...
                <p style="color: #888; font-size: 14px; text-align: center; margin: 0;">
                  This verification link will expire in <strong>i hour</strong>.
                </p>
              </div>
            </div>  
          </div>
