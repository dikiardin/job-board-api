...
exports.buildVerificationEmailChange = void 0;
const buildVerificationEmailChange = (name, token) => {
    return `
      ...
      <tr>
        <td>
          ...
          <p style="color: #555; font-size: 16px; line-height: 1.5;">
            Your email has changed! Please verify your new email address by clicking the button below:
          </p>
            ...
            <div style="text-align: center; margin: 30px 0;">
              <div style="border: 1px solid #ddd; border-radius: 8px; padding: 20px; display: inline-block; background-color: #f9f9f9;">
                <p style="text-align: center; margin: 0 0 15px 0;">
                  <a href="${process.env.FE_URL}/auth/verify-change/${token}" target="_blank" 
          ...
          <p style="color: #888; font-size: 14px;">
            If you didn't made any changes, you can safely ignore this email.
          </p>
