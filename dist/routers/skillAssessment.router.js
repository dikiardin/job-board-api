...
class SkillAssessmentRouter {
    ...
    initializeRoutes() {
        ...
        this.route.post("/badge-templates", verifyToken_1.verifyToken, (0, verifyRole_1.verifyRole)([prisma_1.UserRole.DEVELOPER]), (0, uploadImage_1.uploadSingle)("icon"), badgeTemplate_controller_1.BadgeTemplateController.createBadgeTemplate);
        ...
        this.route.patch("/badge-templates/:templateId", verifyToken_1.verifyToken, (0, verifyRole_1.verifyRole)([prisma_1.UserRole.DEVELOPER]), badgeTemplate_validator_1.validateTemplateId, (0, uploadImage_1.uploadSingle)("icon"), badgeTemplate_validator_1.validateUpdateBadgeTemplate, badgeTemplate_controller_1.BadgeTemplateController.updateBadgeTemplate);
