...
class JobRouter {
    ...
    initializeRoutes() {
        ...
        this.route.get("/companies/:companyId/jobs/:jobId/applicants", verifyToken_1.verifyToken, (0, verifyRole_1.verifyRole)([prisma_1.UserRole.ADMIN]), job_controller_1.JobController.applicantsList);
        // Update applicant status (IN_REVIEW / INTERVIEW / ACCEPTED / REJECTED)
        this.route.put("/companies/:companyId/jobs/:jobId/applications/:applicationId/status", verifyToken_1.verifyToken, (0, verifyRole_1.verifyRole)([prisma_1.UserRole.ADMIN]), job_controller_1.JobController.updateApplicantStatus);
    }
    getRouter() {
        return this.route;
    }
