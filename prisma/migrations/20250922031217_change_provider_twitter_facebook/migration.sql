/*
  ...
  - The values [APPLE,MICROSOFT] on the enum `ProviderType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."ProviderType_new" AS ENUM ('GOOGLE', 'TWITTER', 'FACEBOOK');
